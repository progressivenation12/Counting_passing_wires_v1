**Консольная программа написаная для использования в личных целях.**  
...
**Update 29.08.2024**
В программу добавленно чтение Excel форматов **.xlsx** и **.xls.** Чтение форматов **~~.txt~~** не поддерживется.  